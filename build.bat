...
REM JDK:    C:\Program Files\AdoptOpenJDK\jdk-11.0.7.10-hotspot\bin
REM JRE:    C:\Program Files\AdoptOpenJDK\jre-11.0.7.10-hotspot\bin
REM JavaFX: C:\Users\Jun\javafx-sdk-11.0.2\lib
...
REM "C:\Program Files\AdoptOpenJDK\jre-11.0.7.10-hotspot\bin\javaw.exe" --module-path "C:\Users\Jun\javafx-sdk-11.0.2\lib" --add-modules javafx.controls,javafx.fxml -Dfile.encoding=UTF-8 -classpath "C:\Users\Jun\Desktop\github\MilkyWay" application.Main
...
java --module-path "C:\Users\Jun\javafx-sdk-11.0.2\lib" --add-modules javafx.controls,javafx.fxml -jar executable.jar
